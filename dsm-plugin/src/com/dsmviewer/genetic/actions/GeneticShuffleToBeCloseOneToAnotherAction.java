...
public class GeneticShuffleToBeCloseOneToAnotherAction extends Action {
	private final DsmTableController dsmTableController;

    public GeneticShuffleToBeCloseOneToAnotherAction(DsmTableController dsmTableController)
    {
    ...
    public String getToolTipText() {
        return "Shuffle matrix to move all cells close one to another with genetic algorithms";
    }

    @Override
    public ImageDescriptor getImageDescriptor() {
        return Activator.getImageDescriptorFromRegistry("dsm-clust-2.png");
    }
}
